import { k as createSvgIcon, j as jsxRuntimeExports, r as reactExports, _ as useNavigate, u as useAuth, B as Box, C as CircularProgress, A as Alert, $ as SchoolIcon, T as Typography, a as Chip, a0 as List, a1 as ListItem, a2 as ListItemButton, a3 as ListItemText, b as routes, g as Button } from "./index-BnUnq6VV.js";
import { d as dayjs } from "./dayjs.min-C4R-6fGg.js";
import { g as getAllLearningHistories } from "./learningHistories-Dl1mfihN.js";
...
function FlashManStatsPageContent() {
  ...
  const loadData = reactExports.useCallback(async () => {
    try {
      setLoading(true);
      const data = await getAllLearningHistories(user?.id);
      setHistories(data);
    } catch (err) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { p: 2, display: "flex", flexDirection: "column", gap: 2 }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Box,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { sx: { p: 1.5, "&:last-child": { pb: 1.5 } }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { display: "flex", alignItems: "center", mb: 0.5 }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(SchoolIcon, { color: "primary", fontSize: "small", sx: { mr: 0.5 } }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "caption", color: "text.secondary", children: "오늘 학습" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "h5", sx: { fontWeight: "bold" }, children: stats.todayCount }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "caption", color: "text.secondary", children: "세션" })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { sx: { p: 1.5, "&:last-child": { pb: 1.5 } }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { display: "flex", alignItems: "center", mb: 0.5 }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUpIcon, { color: "success", fontSize: "small", sx: { mr: 0.5 } }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "caption", color: "text.secondary", children: "전체 학습" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "h5", sx: { fontWeight: "bold" }, children: stats.total }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "caption", color: "text.secondary", children: "세션" })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { sx: { p: 1.5, "&:last-child": { pb: 1.5 } }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { display: "flex", alignItems: "center", mb: 0.5 }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CalendarMonthIcon, { color: "info", fontSize: "small", sx: { mr: 0.5 } }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "caption", color: "text.secondary", children: "연속 학습" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "h5", sx: { fontWeight: "bold" }, children: stats.streak }),
          ...
          ListItemButton,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              ListItemText,
              {
                ...
                primary: /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { display: "flex", alignItems: "center", gap: 0.5 }, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Chip, { label: `${pg.count}회`, size: "small", sx: { flexShrink: 0 } }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { minWidth: 0 }, children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Typography,
                      {
                        variant: "body2",
                        sx: { fontFamily: "monospace", wordBreak: "break-all", lineHeight: 1.3 },
                        children: pg.path
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    stats.recommendations.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Box, { sx: { display: "flex", flexDirection: "column", gap: 1 }, children: stats.recommendations.map((rec) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { variant: "outlined", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { sx: { pb: 1, "&:last-child": { pb: 1 } }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 1 }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { flex: 1, minWidth: 0 }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "body2", sx: { fontWeight: "medium", wordBreak: "break-all" }, children: fileName }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Typography,
                {
                  variant: "caption",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { display: "flex", gap: 1, mt: 1, flexWrap: "wrap" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Chip,
              {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Button,
      {
        variant: "outlined",
        fullWidth: true,
        onClick: () => navigate(routes.flashMan.contents.$()),
        children: "콘텐츠 탐색"
      }
    )
  ] });
...
//# sourceMappingURL=index-Cj0v1uWM.js.map
