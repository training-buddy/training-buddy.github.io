import { r as reactExports, p as useDefaultProps, ad as ListContext, j as jsxRuntimeExports, q as clsx, t as composeClasses, ae as getListItemIconUtilityClass, v as styled, z as memoTheme, c as Dialog, B as Box, C as CircularProgress, af as useAtomValue, d as DialogTitle, e as DialogContent, ag as TextField, a0 as List, a2 as ListItemButton, a3 as ListItemText, T as Typography, f as DialogActions, g as Button, A as Alert, I as IconButton, ah as FormControl, ai as FormLabel, P as Paper } from "./index-BnUnq6VV.js";
import { F as FolderOpenIcon } from "./FolderOpen-Bazxfb0M.js";
import { N as NumberSpinner } from "./NumberSpinner-eb9vCwOE.js";
import { t as toLocalDateKey } from "./date-5ZZ1N3rr.js";
import { b as calculateTotalSessions, d as calculateEndDate, A as ALL_WEEKDAYS, a as getWeekDayLabel, e as formatYearDate } from "./schedule-BIUys4DM.js";
import { u as useOctokit, g as getContents, c as countFlashManFiles, f as flashManConfigAtom, a as useRepositoryList, A as Autocomplete, B as Breadcrumbs, L as Link, F as FolderIcon, R as RadioGroup, b as Radio, T as ToggleButtonGroup, d as ToggleButton } from "./hooks-BN7PAZ-h.js";
import { u as useQuery } from "./useQuery-FkbKXP6M.js";
import { S as Stack } from "./Stack-DNG_CLkZ.js";
import { F as FormControlLabel } from "./FormControlLabel-D7dNxf5V.js";
...
function PlanForm({
  ...
  const [formData, setFormData] = reactExports.useState({
    ...
    startDate: initialData?.startDate ?? toLocalDateKey(/* @__PURE__ */ new Date())
  });
  const previewPlan = {
    name: formData.name,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { component: "form", onSubmit: handleSubmit, sx: { pb: 2 }, children: [
...
//# sourceMappingURL=planFormUtils-DNeD_x4t.js.map
