import { k as createSvgIcon, j as jsxRuntimeExports, s as supabase, r as reactExports, u as useAuth, _ as useNavigate, A as Alert, B as Box, bA as CalendarToday, T as Typography, a as Chip, I as IconButton, g as Button, i as Link, b as routes, C as CircularProgress, c as Dialog, d as DialogTitle, e as DialogContent, f as DialogActions, bB as useParams } from "./index-BnUnq6VV.js";
import { u as updateTrainingPlan, d as deleteTrainingPlan, a as getTrainingPlan } from "./trainingPlans-DsaZpT-m.js";
import { P as PlanExecutionButton } from "./PlanExecutionButton-CHLfdARg.js";
import { u as useQuery } from "./useQuery-FkbKXP6M.js";
import { c as getTrainingExecutionsByPlanId } from "./trainingExecutions-G_KzpqQW.js";
import { b as calculateTotalSessions, d as calculateEndDate, e as formatYearDate, a as getWeekDayLabel } from "./schedule-BIUys4DM.js";
import { r as renderUnit } from "./unit-utils-CtV2B9Q3.js";
import { C as Card, a as CardContent } from "./CardContent-Bf2x5ekB.js";
...
import { C as CardActions } from "./CardActions-DZrkRbmx.js";
import { D as DialogContentText } from "./DialogContentText-CcNFBbG9.js";
import { B as BackIcon } from "./ArrowBack-BUGsCN8I.js";
...
function useTrainingExecutions(planId) {
  const { user } = useAuth();
  return useQuery({
    queryKey: ["useTrainingExecutions", planId, user?.id],
    queryFn: () => {
      return getTrainingExecutionsByPlanId(planId, user?.id);
    },
    enabled: !!user
  });
}
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { display: "flex", justifyContent: "space-between", alignItems: "center" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { display: "flex", alignItems: "center", gap: 1, minWidth: 0, flex: 1 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CalendarToday, { sx: { flexShrink: 0 } }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "h6", noWrap: true, children: plan.name }),
          plan.completed_at && /* @__PURE__ */ jsxRuntimeExports.jsx(
            Chip,
            {
              icon: /* @__PURE__ */ jsxRuntimeExports.jsx(CheckCircleIcon, {}),
              label: `완료 ${formatYearDate(new Date(plan.completed_at))}`,
              size: "small",
              color: "success",
              sx: { ml: 1 }
            }
      ...
      isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(LinearProgress, { sx: { my: 1 } }) : progress && /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { display: "flex", justifyContent: "space-between", mb: 0.5, gap: 1 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "body2", color: "text.secondary", sx: { flexShrink: 0 }, children: "진행률" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Typography, { variant: "body2", fontWeight: "medium", noWrap: true, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { display: "flex", justifyContent: "space-between", gap: 1, flexWrap: "wrap" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Typography, { variant: "body2", color: "text.secondary", sx: { flexShrink: 0 }, children: [
          "총 ",
          totalSessions,
          "회"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Typography, { variant: "body2", color: "text.secondary", noWrap: true, children: [
          "종료 예정: ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: formatYearDate(endDate) })
        ] })
      ] })
    ] }),
    ...
    variant === "list" && /* @__PURE__ */ jsxRuntimeExports.jsxs(CardActions, { sx: { justifyContent: "space-between", px: 2, pb: 2 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { component: Link, to: routes.plans.detail.$path({ id: plan.id }, {}), children: "상세보기" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(PlanExecutionButton, { plan, variant: "contained" })
    ] }),
    variant === "detail" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardActions, { sx: { flexWrap: "wrap", gap: 1, px: 2, pb: 2 }, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { display: "flex", gap: 1, flexWrap: "wrap", ml: "auto" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
          ...
          !plan.completed_at && /* @__PURE__ */ jsxRuntimeExports.jsx(PlanExecutionButton, { plan, size: "small", variant: "contained" })
        ] })
      ] }),
...
//# sourceMappingURL=index-C70QLpdZ.js.map
